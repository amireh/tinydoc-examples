...
class CategorySerializer < Rack::API::Serializer
  attributes :id, :name, :icon, :href, :created_at, :updated_at
  optional_attributes :created_at, :updated_at

  def href
    user_category_url({ user_id: object.user_id, category_id: object.id })
  end
end
